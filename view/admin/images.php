...
<div class="mdui-container-fluid">
	...
	<div class="mdui-typo">
	  <h1> <a href="?/images/" target="_blank">Giường hình</a> <small>OneImages</small></h1>
	</div>
	<form action="" method="post">
		...
		<div class="mdui-textfield">
		  <h4>Cho phép khách truy cập tải lên hình ảnh</h4>
		  <label class="mdui-textfield-label"></label>
		  <label class="mdui-switch">
		...
		<div class="mdui-textfield">
		  <h4>Cho phép tải lên các loại tệp</h4>
